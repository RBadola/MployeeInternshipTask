...
const Navbar = () => {
  ...
  return (
    <nav className="w-full h-16  border bg-white border-b-gray-300 flex items-center justify-between px-4">
      ...
      <div className={twMerge(" hidden lg:flex gap-x-2 w-full mx-auto ")}>
      ...
      {openMenu && (
        <div
          className={twMerge(
            "absolute right-0 bg-white  top-16 border-b border-x border-gray-200 px-10 pt-10 pb-5 flex flex-col gap-x-2 z-10 items-center  lg:hidden"
          )}
        >
